...
| Writing | Complete (all steps) | 2026-06-18 |
| Fact-check | Complete (verify-facts.py passed — 5 stories, 32 claims, 58 HIGH; image warnings cosmetic/expected for imagn) | 2026-06-18 |
| Compile | Complete (07-content-data.json — 5 stories, 6 X posts, 0 FB posts, 5 articles, 5 images) | 2026-06-18 |
| Dashboard | Complete (review-dashboard.html, 21 items) | 2026-06-18 |
| PostPlanner Export | Complete (standard 6 posts; TOBI 6 posts) | 2026-06-18 |
| WordPress Publish | Attempted — proxy blocks WordPress API (same as all previous runs) | 2026-06-18 |
| Dashboard Push | Attempted — PAT lacks write access to content-dashboards repo (same as all prior runs) | 2026-06-18 |
...
- **Coverage:** Halle R16 sweep — Zverev def. Hanfmann 6-3, 4-6, 6-2; Shelton def. Quinn 7-5, 6-3; Fritz def. Marozsan; Bellucci def. Collignon 7-6(6), 6-1 (all QF); Badosa stuns Gauff (No. 5) 1-6, 6-3, 6-2 in Berlin (No. 142 vs No. 7, first win since Charleston); Van de Zandschulp upsets defending champion Paul 6-4, 2-6, 6-3 at Queen's Club; Berlin QF set (Sabalenka vs Bartunkova, Badosa vs Pegula, Rybakina through); Wimbledon countdown 11 days (qualifying Monday June 22, draw June 26)
- **Notes:**
  - NOTE: June 17 pipeline had incorrect info on Sabalenka vs Alexandrova (reported as Sabalenka upset, but WTA official confirms Sabalenka won 6-4, 6-4 and is in QF). Today's pipeline reports correct status.
  - verify-facts.py: passed; 32 claims, 58 HIGH; image warnings cosmetic (imagn source, all not_started)
  - compile: 5 stories, 6 X posts, 0 FB posts, 5 articles, 5 images; posting window warnings cosmetic
  - dashboard: 21 items
...
- **PostPlanner exports:** tfr-postplanner-2026-06-16.xlsx (17 posts), tfr-postplanner-tobi-2026-06-16.xlsx (12 TOBI posts)
- **Coverage:** Halle Open Day 2 — Zverev (RG champ) vs Kopriva on home soil; Shelton vs Kyrgios first-ever ATP H2H; FAA/Tiafoe won Day 1; Berlin WTA — 9 of top 10 WTA players (Sabalenka No. 1, Rybakina No. 2, Gauff No. 3; Serena doubles with Mboko again); Queen's Club ATP — de Minaur (top seed) vs Diallo; Majchrzak (fresh Libema title) vs Lehecka (No. 2); Tommy Paul won Day 1; Alcaraz/Draper withdrew; Nottingham WTA — Fernandez, Zheng, Ostapenko, Boulter WC in WTA 250 field; Wimbledon 2026 countdown — 13 days; draw June 26; Sinner defending (no warm-ups except Hurlingham); Alcaraz out; £64.2M record prize; Sabalenka No. 1 women's seed
- **Notes:**
  - verify-facts.py: passed; 28 claims, 53 HIGH; image warnings cosmetic (imagn source, all not_started)
  - compile: 5 stories, 7 X posts, 0 FB posts, 5 articles, 8 images; posting window warnings cosmetic
  - dashboard: 22 items
  - PostPlanner exports: standard (17 posts: 7 X + 10 FB) and TOBI (12 TOBI posts) generated successfully
  - WordPress proxy error: same environment restriction as all prior runs
  - Dashboard push failed: PAT lacks write access to content-dashboards repo (same as all prior runs)
...
- **Posts:** 8 X posts + 10 FB posts (5 long-form + 5 captions) = 18 total
- **Articles:** 5 (bylines: Ryan Calloway [S1, S4], Elena Voss [S2, S5], Marcus Cole [S3])
- **PostPlanner exports:** tfr-postplanner-2026-06-13.xlsx (8 posts), tfr-postplanner-tobi-2026-06-13.xlsx (8 TOBI posts)
- **Coverage:** Stuttgart BOSS Open SFs (Fritz defending champ vs Bublik No. 3, Shelton No. 1 in other SF; Fritz survived back-to-back 3-setters; final Sunday June 14); Queen's Club WTA QF blockbuster (Boulter No. 73 WC stuns Rybakina world No. 2 7-5, 2-6, 6-4 in 2h38m; 2nd career Top 5 win; Vekic LL through; SFs set: Boulter vs Vekic, Jovic vs Raducanu/Rakhimova); Libema Open QF (Majchrzak def. FAA 6-4, 6-3 in 69 min, 85.1% svc pts, 2nd career Top-10 win; Medvedev vs Cilic in other QF); Wimbledon 2026 record £64.2M prize money (20% increase, biggest in 149-year history, singles champ £3.6M each, player protest context); ATP rankings — Sinner No. 1 (13,500 pts) leads Alcaraz (9,960) by 3,500+, Alcaraz confirmed out of Wimbledon wrist injury, Sinner defending without grass warm-ups
- **Notes:**
  - verify-facts.py: 1 run — passed; 40 claims, 73 HIGH; image warnings cosmetic (imagn source, all not_started)
  - compile: 5 stories, 8 X posts, 0 FB posts, 5 articles, 5 images; posting window warnings cosmetic
  - dashboard: 23 items
